...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: 'https://www.calliwickesphotography.com/blogs/tampa-engagement-photographer',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.4,
    },
    ...
    {
      url: 'https://www.calliwickesphotography.com/blogs/demens-landing-park-session',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.4,
    },
    {
      url: 'https://www.calliwickesphotography.com/blogs/vinoy-park-photo-session',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.4,
    },
    {
      url: 'http://calliwickesphotography.com/blogs/bonnet-springs-family-session',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.4,
    },
    {
      url: 'https://www.calliwickesphotography.com/blogs/ybor-engagement-session',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.4,
    },
    {
      url: 'https://www.calliwickesphotography.com/blogs/abercrombie-park-family-session',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.4,
    },
    {
      url: 'https://www.calliwickesphotography.com/blogs/premium-outlet-mall-headshot-session',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.4,
    },
    {
      url: 'http://calliwickesphotography.com/blogs/st-johns-tampa-church-family-session',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.4,
    },
